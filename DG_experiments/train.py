...
import dataloader
import misc
from dataloader import InfiniteDataLoader, FastDataLoader
...
if __name__ == "__main__":
    ...
    parser.add_argument('--algorithm', type=str, default="ERM_SMA")
    ...
    if args.dataset in vars(dataloader):
        dataset = vars(dataloader)[args.dataset](args.data_dir,
    ...
    #algorithm_class = ERM_SMA
    if 'ERM_SMA' == args.algorithm:
        algorithm = ERM_SMA(dataset.input_shape, dataset.num_classes,
            len(dataset) - len(args.test_envs), hparams)
    elif 'ERM' == args.algorithm:
        algorithm = ERM(dataset.input_shape, dataset.num_classes,
            len(dataset) - len(args.test_envs), hparams)
